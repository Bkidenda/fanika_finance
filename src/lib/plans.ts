...
export const PLANS: Plan[] = [
  {
    id: "free",
    name: "Free",
    tagline: "Get your finances organised.",
    priceLabel: "KSh 0",
    per: "/ forever",
    ...
    features: [
      ...
      "Optional automated giving set-aside",
  ...
  },
  {
    id: "pro",
    name: "Fanika Pro",
    tagline: "For the focused individual.",
  ...
  },
  {
    ...
    features: [
      ...
      "Quarterly financial review session",
    ],
  },
];
